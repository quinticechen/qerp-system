...
export const CreateShippingDialog: React.FC<CreateShippingDialogProps> = ({
  ...
  const createShippingMutation = useMutation({
    mutationFn: async (shippingData: {
      ...
      // Create shipping record - shipping_number will be auto-generated by database trigger
      const { data: shipping, error: shippingError } = await supabase
        ...
        .insert({
          ...
          user_id: user.id,
          shipping_number: '' // Provide empty string, will be overwritten by trigger
        } as any)
        .select()
        .single();
      ...
      for (const item of shippingData.items) {
        ...
        if (roll) {
          ...
          const { error: historyError } = await supabase
            ...
            .insert({
              shipping_item_id: shipping.id, // For now use shipping.id, should be actual shipping_item.id
              customer_id: shippingData.customer_id,
